"""
Django settings for OnionAI project.
...
SECRET_KEY = 'django-insecure-3s&+7bes9t*3d2s%7k#&xcwt6g7!n*$4nhscn4#9u231d4lr7a'
...
with open("config/projectconfig.json", "r") as file:
...
WSGI_APPLICATION = 'OnionAI.wsgi.application'
